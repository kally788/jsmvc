...
text+=ret[i+1];}
return text;}}
js.model.MenuList=function(){var protected;var docName={v:"JsMvc API"};var docVersion={v:"1.0"};this.onCreate=function(p){protected=p;p.setData([{"name":"$jsmvc$","list":["run"]},{"name":"$jsmvc$.core","list":["ControAbs","FacadeAbs","ModelAbs","PageAbs"]}]);}
this.getList=function(){return protected.getData();}
